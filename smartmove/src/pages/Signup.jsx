  ...
  return (
    <div className="signup-container">
      <div className="brand-logo">
        <div
          style={{ background: "#000", padding: "6px", borderRadius: "6px" }}
        >
          <img
            src="/truck-icon.svg"
            alt="logo"
      ...
      <div className="signup-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <div className="input-wrapper">
              ...
              >
                <path
                  d="M1.42 12C2.73 7.55 6.6 4 12 4c5.4 0 9.27 3.55 10.58 8-.7 2.72-2.5 4.92-4.83 6.28C15.6 20.06 13.84 20.5 12 20.5c-1.84 0-3.6-.44-6-1.98C3.92 16.92 2.12 14.72 1.42 12z"
                  stroke="#9CA3AF"
                  strokeWidth="1.2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
        ...
        <p className="login-link">
          ...
          <span onClick={() => (onNavigate ? onNavigate("login") : null)}>
            Sign in
          </span>
        </p>
      </div>
